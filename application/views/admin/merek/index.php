          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  <a href="<?=base_url('admin/merek/create');?>" class="btn btn-primary btn-sm">Tambah Data</a>
                </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="myTable" class="table table-bordered table-striped table-sm">
                  ...
                  <tbody>
                    <?php $no=1; foreach ($merek as $item) { ?>
                        <tr>
                          <td><?=$no++;?></td>
                          <td><?=$item['nama'];?></td>
                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item" href="<?=base_url('admin/merek/edit/'.$item['id']);?>">Edit</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?=base_url('admin/merek/destroy/'.$item['id']);?>" onclick="return confirm('Apakah anda ingin menghapus data?');">Hapus</a>
                              </div>
                            </div>
                          </td>
                        </tr>
