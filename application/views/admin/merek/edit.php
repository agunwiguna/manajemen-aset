          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form Ubah Data Merek</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?=base_url('update-merek');?>" method="POST" enctype="multipart/form-data" class="form-horizontal" autocomplete="off">
                <input type="hidden" name="id" value="<?=$merek['id'];?>">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="nama" class="col-sm-2 col-form-label">Nama Merek</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="<?=$merek['nama'];?>" name="nama" id="nama" placeholder="Masukan Nama Merek.." required> 
                    </div>
                  </div>
                  <div class="form-group row">
